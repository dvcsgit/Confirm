...
namespace DataSync.EquipmentMaintenance
{
    public class TagDownloadHelper : IDisposable
    {
        ...
        private string TemplateDbFilePath
        {
            get
            {
                return Path.Combine(Config.EquipmentMaintenanceTagSQLiteTemplateFolderPath, Define.SQLite_EquipmentMaintenanceTag);
            }
        }
        ...
        private string GeneratedFolderPath
        {
            get
            {
                return Path.Combine(Config.EquipmentMaintenanceTagSQLiteGeneratedFolderPath, Guid);
            }
        }
        ...
        private string GeneratedDbFilePath
        {
            get
            {
                return Path.Combine(GeneratedFolderPath, Define.SQLite_EquipmentMaintenanceTag);
            }
        }
        ...
        private string GeneratedZipFilePath
        {
            get
            {
                return Path.Combine(GeneratedFolderPath, Define.SQLiteZip_EquipmentMaintenanceTag);
            }
        }
