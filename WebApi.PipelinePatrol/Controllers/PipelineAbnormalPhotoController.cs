...
{
    public class PipelineAbnormalPhotoController : ApiController
    {
        [HttpGet]
        public HttpResponseMessage GetPhoto(string UniqueID)
        {
            ...
            try
            {
                ...
                RequestResult result = PipelineAbnormalHelper.GetPhoto(UniqueID);
