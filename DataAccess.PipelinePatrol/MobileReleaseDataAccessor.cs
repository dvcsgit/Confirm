        ...
        public static RequestResult Upload(UploadFormModel Model)
        {
            ...
            try
            {
                using (PDbEntities db = new PDbEntities())
                {
                    ...
                    db.Version.Add(new DbEntity.MSSQL.PipelinePatrol.Version()
                    {
                    ...
                    System.IO.File.Copy(Model.TempFile, System.IO.Path.Combine(Config.PipelinePatrolMobileReleaseFolderPath, Model.FormInput.ApkName + "." + Model.Extension));
