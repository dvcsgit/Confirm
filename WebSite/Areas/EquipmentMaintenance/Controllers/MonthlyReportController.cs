...
namespace WebSite.Areas.EquipmentMaintenance.Controllers
{
    public class MonthlyReportController : Controller
    {
        ...
        {
            RequestResult result = MonthlyReportHelper.GetQueryFormModel();
        ...
        {
            RequestResult result = MonthlyReportHelper.Query(Model.Parameters);
        ...
        {
            var model = MonthlyReportHelper.Export(Session["QueryResults"] as ReportModel, ExcelVersion).Data as ExcelExportModel;
        ...
        public ActionResult InitTree()
        {
            try
            {
                ...
                {
                    result = MonthlyReportHelper.GetTreeItem(organizationList, account.UserRootOrganizationUniqueID, Session["Account"] as Account);
                }
                else
                {
                    result = MonthlyReportHelper.GetRootTreeItem(organizationList, account.UserRootOrganizationUniqueID, Session["Account"] as Account);
                }
        ...
        public ActionResult GetTreeItem(string OrganizationUniqueID)
        {
            ...
            try
            {
                ...
                RequestResult result = MonthlyReportHelper.GetTreeItem(organizationList, OrganizationUniqueID, Session["Account"] as Account);
