...
{
    public class RepairFormColumnController : Controller
    {
        ...
        {
            RequestResult result = RepairFormColumnDataAccessor.Query(Parameters);
        ...
        {
            RequestResult result = RepairFormColumnDataAccessor.GetDetailViewModel(UniqueID);
        ...
        {
            return Content(JsonConvert.SerializeObject(RepairFormColumnDataAccessor.Create(Model)));
        }

        [HttpGet]
        public ActionResult Edit(string UniqueID)
        {
            RequestResult result = RepairFormColumnDataAccessor.GetEditFormModel(UniqueID);
        ...
        {
            return Content(JsonConvert.SerializeObject(RepairFormColumnDataAccessor.Edit(Model)));
        }
        ...
        public ActionResult Delete(string Selecteds)
        {
            ...
            try
            {
                ...
                result = RepairFormColumnDataAccessor.Delete(selectedList);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult InitTree()
        {
            try
            {
                ...
                RequestResult result = RepairFormColumnDataAccessor.GetTreeItem(organizationList, "*", Session["Account"] as Account);
        ...
        public ActionResult GetTreeItem(string AncestorOrganizationUniqueID)
        {
            ...
            try
            {
                ...
                RequestResult result = RepairFormColumnDataAccessor.GetTreeItem(organizationList, AncestorOrganizationUniqueID, Session["Account"] as Account);
