...
namespace WebSite.Areas.Customized_ASE_QA.Controllers
{
    public class DailyReportController : Controller
    {
        public ActionResult Index()
        {
            ...
            RequestResult result = DataAccess.ASE.QA.DailyReportHelper.GetQueryFormModel(organizationList);
        ...
        public ActionResult Query(QueryFormModel Model)
        {
            ...
            RequestResult result = DataAccess.ASE.QA.DailyReportHelper.Query(organizationList, Model.Parameters, Session["Account"] as Account);
        ...
        public ActionResult Export()
        {
            ...
            try
            {
                ...
                result = DataAccess.ASE.QA.DailyReportHelper.Export(itemList);
