...
using Utility;
using Models.ASE.AbnormalNotify_v2;
...
{
    public class AbnormalNotify_v2Controller : Controller
    {
        public ActionResult Index(string Status)
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.GetQueryFormModel(Status, organizationList.Where(x => x.ParentUniqueID == "1c8932c1-9cdd-4834-8b1b-d975cf3a0cc2").OrderBy(x => x.ID).ToList(), organizationList, userList);
        ...
        public ActionResult Portal(string UniqueID)
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.GetDetailViewModel(UniqueID, organizationList, userList);
        ...
        public ActionResult Query(QueryFormModel Model)
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.Query(Model.Parameters, organizationList, userList);
        ...
        public ActionResult Reply(string UniqueID)
        {
            var organizationList = HttpRuntime.Cache.GetOrInsert<List<Models.Shared.Organization>>("Organizations", () => OrganizationDataAccessor.GetAllOrganization());
            var userList = HttpRuntime.Cache.GetOrInsert<List<Models.Shared.UserModel>>("Users", () => AccountDataAccessor.GetAllUser());

            RequestResult result = AbnormalNotify_v2DataAccessor.GetReplyFormModel(UniqueID, organizationList, userList);

            if (result.IsSuccess)
            {
                return PartialView("_Reply", result.Data);
            }
            else
            {
                return PartialView("_Error", result.Error);
        ...
        public ActionResult Create()
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.GetCreateFormModel(organizationList.Where(x => x.ParentUniqueID == "1c8932c1-9cdd-4834-8b1b-d975cf3a0cc2").OrderBy(x => x.ID).ToList(), organizationList, userList);
        ...
        public ActionResult Create(CreateFormModel Model)
        {
            ...
            try
            {
                ...
                result = AbnormalNotify_v2DataAccessor.Create(model, Session["Account"] as Account);
        ...
        public ActionResult Edit(string UniqueID)
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.GetEditFormModel(UniqueID, organizationList.Where(x => x.ParentUniqueID == "1c8932c1-9cdd-4834-8b1b-d975cf3a0cc2").OrderBy(x => x.ID).ToList(), userList);
        ...
        public ActionResult Edit(EditFormModel Model)
        {
            ...
            try
            {
                ...
                result = AbnormalNotify_v2DataAccessor.Edit(model, Session["Account"] as Account);
        ...
        {
            return Content(JsonConvert.SerializeObject(AbnormalNotify_v2DataAccessor.TakeJob(Model.UniqueID, Session["Account"] as Account)));
        }
        ...
        public ActionResult Closed(string UniqueID)
        {
            ...
            RequestResult result = AbnormalNotify_v2DataAccessor.GetClosedFormModel(UniqueID, organizationList, userList);
        ...
        {
            return Content(JsonConvert.SerializeObject(AbnormalNotify_v2DataAccessor.Closed(Model)));
        }

        [HttpGet]
        public ActionResult RepairForm(string UniqueID)
        {
            RequestResult result = AbnormalNotify_v2DataAccessor.GetCreateRepairFormModel(UniqueID);
        ...
        {
            return Content(JsonConvert.SerializeObject(AbnormalNotify_v2DataAccessor.CreateRepairForm(Model, (Session["Account"] as Account).ID)));
        }

        public ActionResult Download(string FormUniqueID, int Seq)
        {
            var file = AbnormalNotify_v2DataAccessor.GetFile(FormUniqueID, Seq);
        ...
        public ActionResult InitSelectUserTree()
        {
            try
            {
                ...
                RequestResult result = AbnormalNotify_v2DataAccessor.GetUserTreeItem(organizationList, userList, "2a54f076-f14c-44fd-9f42-b202ac9206e0");
        ...
        public ActionResult GetSelectUserTreeItem(string OrganizationUniqueID)
        {
            ...
            try
            {
                ...
                RequestResult result = AbnormalNotify_v2DataAccessor.GetUserTreeItem(organizationList, userList, OrganizationUniqueID);
        ...
        public ActionResult AddUser(string Selecteds)
        {
            ...
            try
            {
                ...
                if ((Define.EnumFormAction)Session["FormAction"] == Define.EnumFormAction.Create)
                {
                    ...
                    result = AbnormalNotify_v2DataAccessor.AddUser(model.NotifyUserList, selectedList);
        ...
        public ActionResult AddCCUser(string Selecteds)
        {
            ...
            try
            {
                ...
                if ((Define.EnumFormAction)Session["FormAction"] == Define.EnumFormAction.Create)
                {
                    ...
                    result = AbnormalNotify_v2DataAccessor.AddUser(model.NotifyCCUserList, selectedList);
