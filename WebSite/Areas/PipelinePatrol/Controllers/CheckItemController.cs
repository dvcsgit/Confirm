...
using Models.PipelinePatrol.CheckItemManagement;
using Models.Shared;
...
namespace WebSite.Areas.PipelinePatrol.Controllers
{
    public class CheckItemController : Controller
    {
        ...
        public ActionResult InitTree()
        {
            try
            {
                RequestResult result = CheckItemDataAccessor.GetTreeItem("*", "", Session["Account"] as Account);
        ...
        public ActionResult GetTreeItem(string OrganizationUniqueID, string CheckType)
        {
            ...
            try
            {
                RequestResult result = CheckItemDataAccessor.GetTreeItem(OrganizationUniqueID, CheckType, Session["Account"] as Account);
        ...
        public ActionResult InitSelectTree(string RefOrganizationUniqueID)
        {
            try
            {
                RequestResult result = AbnormalReasonDataAccessor.GetTreeItem(RefOrganizationUniqueID, "*", "");
        ...
        public ActionResult GetSelectTreeItem(string RefOrganizationUniqueID, string OrganizationUniqueID, string AbnormalType)
        {
            ...
            try
            {
                RequestResult result = AbnormalReasonDataAccessor.GetTreeItem(RefOrganizationUniqueID, OrganizationUniqueID, AbnormalType);
