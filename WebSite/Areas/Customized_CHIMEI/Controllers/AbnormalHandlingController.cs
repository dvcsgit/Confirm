...
namespace WebSite.Areas.Customized_CHIMEI.Controllers
{
    public class AbnormalHandlingController : Controller
    {
        ...
        {
            var queryResults = Session["QueryResults"] as GridViewModel;

            RequestResult result = AbnormalHandlingDataAccessor.GetDetailViewModel(queryResults.ItemList.First(x => x.UniqueID == UniqueID));
        ...
        public ActionResult Edit(string UniqueID)
        {
            ...
            RequestResult result = AbnormalHandlingDataAccessor.GetEditFormModel(queryResults.ItemList.First(x => x.UniqueID == UniqueID));
        ...
        public ActionResult Abnormal()
        {
            ...
            return Content(JsonConvert.SerializeObject(AbnormalHandlingDataAccessor.GetAIMSLink(model, Session["Account"] as Account, Url)));
        }
        ...
        public ActionResult InitTree()
        {
            try
            {
                ...
                {
                    result = DataAccess.EquipmentMaintenance.EquipmentDataAccessor.GetTreeItem(organizationList, account.UserRootOrganizationUniqueID, Session["Account"] as Account);
                }
                else
                {
                    result = DataAccess.EquipmentMaintenance.EquipmentDataAccessor.GetRootTreeItem(organizationList, account.UserRootOrganizationUniqueID, Session["Account"] as Account);
                }
        ...
        public ActionResult GetTreeItem(string OrganizationUniqueID)
        {
            ...
            try
            {
                ...
                RequestResult result = DataAccess.EquipmentMaintenance.EquipmentDataAccessor.GetTreeItem(organizationList, OrganizationUniqueID, Session["Account"] as Account);
