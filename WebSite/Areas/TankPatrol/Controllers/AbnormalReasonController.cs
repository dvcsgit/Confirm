...
using Models.TankPatrol.AbnormalReasonManagement;
    ...
    public class AbnormalReasonController : Controller
    {
        ...
        public ActionResult InitTree()
        {
            try
            {
                ...
                {
                    result = AbnormalReasonDataAccessor.GetTreeItem(organizationList, account.UserRootOrganizationUniqueID, "", Session["Account"] as Account);
                }
                else
                {
                    result = AbnormalReasonDataAccessor.GetRootTreeItem(organizationList, account.UserRootOrganizationUniqueID, Session["Account"] as Account);
                }
        ...
        public ActionResult GetTreeItem(string OrganizationUniqueID, string AbnormalType)
        {
            ...
            try
            {
                ...
                RequestResult result = AbnormalReasonDataAccessor.GetTreeItem(organizationList, OrganizationUniqueID, AbnormalType, Session["Account"] as Account);
        ...
        public ActionResult InitSelectTree(string RefOrganizationUniqueID)
        {
            try
            {
                ...
                RequestResult result = HandlingMethodDataAccessor.GetTreeItem(organizationList, RefOrganizationUniqueID, "*", "");
        ...
        public ActionResult GetSelectTreeItem(string RefOrganizationUniqueID, string OrganizationUniqueID, string HandlingMethodType)
        {
            ...
            try
            {
                ...
                RequestResult result = HandlingMethodDataAccessor.GetTreeItem(organizationList, RefOrganizationUniqueID, OrganizationUniqueID, HandlingMethodType);
