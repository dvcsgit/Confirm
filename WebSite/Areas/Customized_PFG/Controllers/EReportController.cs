...
{
    public class EReportController : Controller
    {
        ...
        {
            RequestResult result = EReportHelper.Query(Model.Parameters);
        ...
        {
            var model = EReportHelper.Export(Session["QueryResults"] as ReportModel, ExcelVersion).Data as ExcelExportModel;
        ...
        public ActionResult InitTree()
        {
            try
            {
                RequestResult result = EReportHelper.GetTreeItem("*", Session["Account"] as Account);
        ...
        public ActionResult GetTreeItem(string OrganizationUniqueID)
        {
            ...
            try
            {
                RequestResult result = EReportHelper.GetTreeItem(OrganizationUniqueID, Session["Account"] as Account);
