...
{
    public class EquipmentFixHourController : Controller
    {
        // GET: EquipmentMaintenanceReport/EquipmentFixHour
        ...
        {
            RequestResult result = EquipmentFixHourDataAccessor.Query(Model.Parameters);
        ...
        {
            var excel = EquipmentFixHourDataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
