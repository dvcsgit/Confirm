...
{
    public class UnArriveResultAnalyzeController : Controller
    {
        ...
        {
            RequestResult result = UnArriveResultAnalyzeDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = UnArriveResultAnalyzeDataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
