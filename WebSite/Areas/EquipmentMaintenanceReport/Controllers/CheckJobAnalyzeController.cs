...
{
    public class CheckJobAnalyzeController : Controller
    {
        ...
        {
            RequestResult result = CheckJobAnalyzeDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = CheckJobAnalyzeDataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
