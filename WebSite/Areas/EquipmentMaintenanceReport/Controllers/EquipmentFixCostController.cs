...
{
    public class EquipmentFixCostController : Controller
    {
        // GET: EquipmentMaintenanceReport/EquipmentFix
        ...
        {
            RequestResult result = EquipmentFixCostDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var model = EquipmentFixCostDataAccessor.Export((Session["QueryResults"] as GridViewModel).ItemList, ExcelVersion).Data as ExcelExportModel;
