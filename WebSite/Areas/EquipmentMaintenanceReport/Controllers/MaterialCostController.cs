...
namespace WebSite.Areas.EquipmentMaintenanceReport.Controllers
{
    public class MaterialCostController : Controller
    {
        ...
        {
            RequestResult result = MaterialCostDataAccessor.Query(Model.Parameters);
        ...
        {
            var excel = MaterialCostDataAccessor.Export(Session["QueryResults"] as MaterialViewModel, ExcelVersion);
