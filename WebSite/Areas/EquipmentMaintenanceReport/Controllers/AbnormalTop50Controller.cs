...
{
    public class AbnormalTop50Controller : Controller
    {
        ...
        {
            RequestResult result = AbnormalTop50DataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = AbnormalTop50DataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
