...
{
    public class CheckResultHourController : Controller
    {
        ...
        {
            RequestResult result = CheckResultHoursDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = CheckResultHoursDataAccessor.Export(Session["QueryResults"] as List<GridItem>, ExcelVersion);
