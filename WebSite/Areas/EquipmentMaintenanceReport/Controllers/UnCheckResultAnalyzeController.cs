...
{
    public class UnCheckResultAnalyzeController : Controller
    {
        ...
        {
            RequestResult result = UnCheckResultAnalyzeDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = UnCheckResultAnalyzeDataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
