...
{
    public class MaintanceScheduleController : Controller
    {
        ...
        {
            RequestResult result = MaintanceScheduleDataAccessor.Query(Model.Parameters, Session["Account"] as Account);
        ...
        {
            var excel = MaintanceScheduleDataAccessor.Export(Session["QueryResults"] as GridViewModel, ExcelVersion);
