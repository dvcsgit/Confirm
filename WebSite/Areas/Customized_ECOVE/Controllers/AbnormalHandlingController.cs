using Customized.ECOVE.DataAccess;
...
namespace WebSite.Areas.Customized_ECOVE.Controllers
{
    public class AbnormalHandlingController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Save(string Remark, string VHNO)
        {
        ...
        [HttpPost]
        public ActionResult Closed(string Remark, string VHNO)
        {
            RequestResult result = new RequestResult();
        ...
        public ActionResult InitTree()
        {
            try
            {
                var organizationList = HttpRuntime.Cache.GetOrInsert<List<Models.Shared.Organization>>("Organizations", () => DataAccess.OrganizationDataAccessor.GetAllOrganization());
